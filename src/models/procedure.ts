...
export class Procedure {
    ...
    constructor() {
        ...
        this.entry.push(new Mode("asd",55,55,0,0,{hue: 50,saturation: 255,value: 255},60,17))
        this.entry.push(new Mode("asd",90,150,0,0,{hue: 39,saturation: 47,value: 255},60,21))
        this.entry.push(new Mode("asd",255,255,0,0,{hue: 178,saturation: 180,value: 255},60,10))
        ...
        this.entry.push(new Mode("asd",100,255,0,0,{hue: 190,saturation: 140,value: 255},120,2))
        this.entry.push(new Mode("asd",255,255,0,0,{hue: 255,saturation: 255,value: 255},60,17))
        this.entry.push(new Mode("asd",180,18,0,0,{hue: 0,saturation: 90,value: 255},45,10))
        this.entry.push(new Mode("asd",100,30,0,0,{hue: 0,saturation: 125,value: 200},30,6));
        this.entry.push(new Mode("asd",180,18,0,0,{hue: 90,saturation: 90,value: 255},60,10))
        ...
        this.entry.push(new Mode("asd",180,255,0,0,{hue: 0,saturation: 90,value: 255},60,10))
